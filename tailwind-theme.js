...
export default {
  ...
  "family:box": {
    decorator:
      "block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-zinc-500 text-transparent peer-checked:text-zinc-500",
    decoratorIcon:
  ...
  "family:button": {
    input:
      "$reset inline-flex items-center bg-zinc-800 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
  ...
  "family:dropdown": {
    ...
    inner:
      "max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-zinc-500 focus-within:ring-2 rounded mb-2 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-zinc-500",
    input: "w-full px-3 py-2",
    listbox: "bg-white shadow-lg rounded overflow-hidden",
    listboxButton: "flex w-12 self-stretch justify-center mx-auto",
    listitem:
      'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 aria-selected:bg-zinc-600 aria-selected:text-white data-[is-active="true"]:aria-selected:bg-zinc-600 data-[is-active="true"]:aria-selected:bg-zinc-700',
    loaderIcon: "ml-auto",
    loadMoreInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-zinc-500 formkit-loading:text-gray-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0",
    option: "p-2.5",
  ...
  "family:text": {
    inner:
      " bg-zinc-100 flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-zinc-500 rounded mb-1",
    input:
      "w-full px-3 py-2 border-none text-base text-gray-700 placeholder-gray-400",
  },
  "family:date": {
    inner:
      "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-zinc-500 rounded mb-1",
  ...
  select: {
    inner:
      "flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-zinc-500",
    input:
  ...
  textarea: {
    inner:
      "flex bg-zinc-100 rounded mb-1 ring-1 ring-gray-400 focus-within:ring-zinc-500 [&>label:first-child]:focus-within:text-zinc-500",
    input:
  ...
  datepicker: {
    ...
    `,
    timeInput:
      "w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-zinc-500",
  ...
  toggle: {
    ...
    track:
      "p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-zinc-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0",
  ...
  transferlist: {
    ...
    transferlistListItem:
      "pl-8 relative aria-selected:bg-zinc-600 aria-selected:data-[is-active=true]:bg-zinc-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-zinc-500 data-[is-active=true]:bg-gray-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center",
