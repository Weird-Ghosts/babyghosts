...
export default {
  ...
  global: {
    fieldset: "border-none rounded m-0 pb-1",
    help: "text-xs text-zinc-500",
    inner:
      "formkit-disabled:bg-zinc-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none",
    input:
      "appearance-none bg-transparent focus:outline-none focus:ring-0 focus:shadow-none",
    label: "block mb-1 font-bold text-sm",
    legend: "font-bold text-sm",
    loaderIcon: "inline-flex items-center w-4 text-zinc-600 animate-spin",
    message: "text-red-500 mb-1 text-xs",
    messages: "list-none p-0 mt-1 mb-0",
    outer: "formkit-disabled:opacity-50",
    prefixIcon:
      "w-10 flex self-stretch grow-0 shrink-0 rounded-tl rounded-bl border-r border-zinc-400 bg-white bg-gradient-to-b from-transparent to-zinc-200 [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
    suffixIcon:
  ...
  "family:box": {
    decorator:
      "block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-zinc-200 ring-1 ring-zinc-400 peer-checked:ring-zinc-500 text-transparent peer-checked:text-zinc-500",
    decoratorIcon:
    ...
    inner: "$remove:formkit-disabled:bg-zinc-200",
    label: "$reset text-sm text-zinc-700 mt-1 select-none",
    wrapper: "flex items-center mb-1",
  },
  "family:button": {
    input:
      "$reset inline-flex items-center bg-zinc-800 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-zinc-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
  ...
  "family:dropdown": {
    ...
    emptyMessageInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-zinc-500 [&>span]:mr-3 [&>span]:ml-0",
    inner:
      "max-w-md relative flex ring-1 bg-zinc-50 ring-zinc-400 focus-within:ring-zinc-500 focus-within:ring-2 rounded mb-2 formkit-disabled:focus-within:ring-zinc-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-zinc-500",
    input: "w-full px-3 py-2",
    listbox: "bg-white shadow-lg rounded overflow-hidden",
    listboxButton: "flex w-12 self-stretch justify-center mx-auto",
    listitem:
      'pl-7 relative hover:bg-zinc-300 data-[is-active="true"]:bg-zinc-300 aria-selected:bg-zinc-600 aria-selected:text-white data-[is-active="true"]:aria-selected:bg-zinc-600 data-[is-active="true"]:aria-selected:bg-zinc-700',
    loaderIcon: "ml-auto",
    loadMoreInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-zinc-500 formkit-loading:text-zinc-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0",
    option: "p-2.5",
    optionLoading: "pl-2.5 text-zinc-400",
    placeholder: "p-2.5 text-zinc-400",
    selector:
  ...
  "family:text": {
    inner:
      " bg-zinc-100 flex items-center max-w-md ring-1 ring-zinc-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-zinc-500 rounded mb-1",
    input:
      "w-full px-3 py-2 border-none text-base text-zinc-700 placeholder-zinc-400",
  },
  "family:date": {
    inner:
      "flex items-center max-w-md ring-1 ring-zinc-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-zinc-500 rounded mb-1",
    input: "w-full px-3 py-2 border-none text-zinc-700 placeholder-zinc-400",
  },
  ...
  file: {
    fileItem: "flex items-center text-zinc-800 mb-1 last:mb-0",
    ...
    fileRemove:
      "relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-zinc-500 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]",
    ...
    noFiles: "flex w-full items-center px-3 py-2 text-zinc-400",
  ...
  select: {
    inner:
      "flex relative max-w-md items-center rounded mb-1 ring-1 ring-zinc-400 focus-within:ring-zinc-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-zinc-500",
    input:
      'w-full pl-3 pr-8 py-2 border-none text-base text-zinc-700 placeholder-zinc-400 formkit-multiple:p-0 data-[placeholder="true"]:text-zinc-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
    selectIcon:
      "flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none [&>svg]:w-[1em]",
    option: "formkit-multiple:p-3 formkit-multiple:text-sm text-zinc-700",
  },
  textarea: {
    inner:
      "flex bg-zinc-100 rounded mb-1 ring-1 ring-zinc-400 focus-within:ring-zinc-500 [&>label:first-child]:focus-within:text-zinc-500",
    input:
      "block w-full h-32 px-3 py-3 border-none text-base text-zinc-700 placeholder-zinc-400 focus:shadow-outline",
  },
  ...
  autocomplete: {
    ...
    selectionWrapper: `
      absolute left-0 top-0 right-0 bottom-0 flex rounded bg-zinc-100
  ...
  colorpicker: {
    ...
    inner: `
      ...
      group-[[data-inline]]:!ring-zinc-400
    `,
    swatchPreview: `
      w-full
      flex
  ...
  datepicker: {
    ...
    overlayPlaceholder: "text-zinc-400",
    months: "flex flex-wrap",
    month: `
      flex items-center justify-center
      w-[calc(33%_-_1em)] m-2 p-2 rounded-md
      bg-zinc-200
      aria-selected:bg-zinc-500 aria-selected:text-white
      focus:outline focus:outline-2 focus:outline-zinc-500 focus:outline-offset-2 focus:bg-white focus:text-black
    ...
    `,
    timeInput:
      "w-full border-2 border-zinc-300 rounded-md p-2 my-[2em] focus-visible:outline-zinc-500",
    daysHeader: "flex items-center justify-center",
    prev: "mr-auto px-3 py-1 hover:bg-zinc-100 hover:rounded-lg col-start-1 col-end-1",
    prevLabel: "hidden",
    prevIcon: "flex w-3 select-none [&>svg]:w-full",
    dayButton:
      "appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-zinc-500",
    monthButton:
      "appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-zinc-500",
    yearButton:
      "appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-zinc-500",
    next: "ml-auto px-3 py-1 hover:bg-zinc-100 hover:rounded col-start-3 col-end-3",
    nextLabel: "hidden",
    nextIcon: "flex w-3 select-none [&>svg]:w-full",
    openButton: `
      appearance-none border-0 bg-transparent flex p-0 self-stretch cursor-pointer
      focus-visible:outline-none focus-visible:text-white focus-visible:bg-zinc-500
    `,
    calendarIcon:
  ...
  dropdown: {
    ...
    tag: "flex items-center rounded-full bg-zinc-200 text-xs text-black py-1 px-2.5 cursor-default",
    tagLabel: "px-1",
    ...
    truncationCount:
      "flex items-center whitespace-nowrap justify-center rounded text-white bg-zinc-500 font-bold text-xs px-1 py-0.5",
  ...
  repeater: {
    ...
    controls: "flex flex-col items-center justify-center bg-zinc-100 p-3",
    downControl:
      "hover:text-zinc-500 disabled:hover:text-inherit disabled:opacity-25",
    fieldset: "mt-4",
    help: "mb-2 mt-1.5",
    item: "flex w-full mb-1 rounded border border-zinc-200",
  ...
  slider: {
    ...
    trackWrapper: "px-[2px] rounded-full bg-zinc-200",
    trackInner: "h-[6px] mx-[2px] relative",
    fill: "h-full rounded-full absolute top-0 mx-[-4px] bg-zinc-500",
    marks: "absolute pointer-events-none left-0 right-0 top-0 bottom-0",
    mark: 'absolute top-1/2 w-[3px] h-[3px] rounded-full -translate-x-1/2 -translate-y-1/2 bg-zinc-400 data-[active="true"]:bg-white',
    markLabel:
      "absolute top-[calc(100%+0.5em)] left-1/2 text-zinc-400 text-[0.66em] -translate-x-1/2",
    handles: "m-0 p-0 list-none",
    handle:
      'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-zinc-500 data-[is-target="true"]:z-[3]',
    tooltip:
      'absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-[4px] bg-zinc-500 text-white py-1 px-2 text-xs leading-none whitespace-nowrap rounded-sm opacity-0 pointer-events-none transition-opacity after:content-[""] after:absolute after:top-full after:left-1/2 after:-translate-x-1/2 after:-translate-y-[1px] after:border-4 after:border-transparent after:border-t-zinc-500 group-hover:opacity-100 group-focus-visible:opacity-100 group-data-[show-tooltip="true"]:opacity-100',
    linkedValues: "flex items-start justify-between",
    minValue:
      'grow max-w-[45%] mb-0 relative [&_.formkit-inner::after]:content-[""] [&_.formkit-inner::after]:absolute [&_.formkit-inner::after]:left-[105%] [&_.formkit-inner::after]:-translate-y-1/2 [&_.formkit-inner::after]:w-[10%] [&_.formkit-inner::after]:h-[1px] [&_.formkit-inner::after]:bg-zinc-500',
    maxValue: "grow max-w-[45%] mb-0 relative",
    chart:
      "relative z-[2] mb-2 flex justify-between items-center w-full aspect-[3/1]",
    chartBar:
      'absolute bottom-0 h-full bg-zinc-400 opacity-[.66] data-[active="false"]:opacity-[.25]',
  },
  taglist: {
    input: "px-1 py-1 w-[0%] grow",
    removeSelection: "w-2.5 mx-1 self-center text-black leading-none",
    tag: "flex items-center my-1 p-1 bg-zinc-200 text-xs rounded-full",
    tagWrapper:
      "mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-zinc-500 [&>div>button]:focus:text-white",
    tagLabel: "pl-2 pr-1",
  ...
  toggle: {
    ...
    thumb:
      "relative left-0 aspect-square rounded-full transition-all w-5 bg-zinc-100",
    track:
      "p-0.5 min-w-[3em] relative rounded-full transition-all bg-zinc-400 peer-checked:bg-zinc-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0",
    valueLabel: "font-bold text-sm",
    wrapper: "flex flex-wrap items-center mb-1",
  },
  transferlist: {
    outer: `
      [&_.dnd-placeholder]:bg-zinc-500 [&_.dnd-placeholder]:text-white
    ...
    help: "pb-2",
    transferlist:
      "sm:w-3/5 shadow-md flex flex-col min-h-[350px] max-h-[350px] border rounded overflow-hidden select-none bg-zinc-50",
    transferlistHeader:
      "flex bg-zinc-100 justify-between items-center border-b p-3",
    transferlistHeaderItemCount: "ml-auto text-sm",
    transferlistListItems:
      "list-none bg-zinc-50 h-full sm:max-w-xs overflow-x-hidden overflow-y-auto",
    transferlistListItem:
      "pl-8 relative aria-selected:bg-zinc-600 aria-selected:data-[is-active=true]:bg-zinc-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-zinc-500 data-[is-active=true]:bg-zinc-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center",
    transferlistOption: "text-sm",
    transferControls:
      "flex sm:flex-col justify-center mx-auto my-2 sm:mx-2 sm:my-auto border rounded",
    transferlistButton:
      "text-sm disabled:cursor-not-allowed disabled:bg-zinc-200 disabled:opacity-50 first:rounded-l last:rounded-r sm:first:rounded-t sm:last:rounded-b appearance-none p-2 m-0 cursor-pointer h-10 border-none rounded-none bg-zinc-50 hover:outline disabled:hover:outline-none hover:outline-1 hover:outline-black hover:text-zinc-500 disabled:hover:text-current hover:z-10",
    sourceEmptyMessage:
      "appearance-none border-none w-full p-0 m-0 text-center text-zinc-500 italic",
